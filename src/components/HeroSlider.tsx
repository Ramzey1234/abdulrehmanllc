...
const heroSlides = [
  {
    ...
    subtitle: "Premium lifestyle essentials for the modern soul.",
    color: "text-[#171717]",
    bgOverlay: "from-neutral-200/40 via-neutral-100/25",
  },
  {
    id: 2,
    image: "/assets/images/beige.webp", // Placeholder
    title: "Modern Elegance.",
    subtitle: "Curated collections that define sophistication.",
    color: "text-[#404040]",
    bgOverlay: "from-neutral-100/40 via-neutral-50/25",
  },
  {
    id: 3,
    image: "/assets/images/banner.jpg", // Reusing for demo
    title: "The Art of Living.",
    subtitle: "Exquisite details crafted for a timeless home.",
    color: "text-[#0a0a0a]",
    bgOverlay: "from-neutral-100/40 via-neutral-100/25",
  },
];
