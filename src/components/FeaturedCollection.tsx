...
export const FeaturedCollection = ({
  ...
  return (
    <section className="py-24 bg-[#ffffff] relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-gradient-to-b from-[#e5e5e5]/40 to-transparent rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none" />

      <div className="container-page relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <h2 className="text-4xl md:text-5xl font-light text-[#171717] mb-4">
            {title}
          </h2>
          <div className="h-px w-24 bg-[#000] mx-auto mb-6" />
          <p className="text-[#404040] text-lg font-light leading-relaxed">
            {subtitle}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {products.map((product) => (
            ...
            >
              <div className="relative aspect-[4/5] overflow-hidden rounded-2xl bg-[#fafafa] shadow-sm transition-all duration-500 group-hover:shadow-[0_20px_40px_rgba(124,58,237,0.1)]">
                <Image
                  src={product.img}
                  alt={product.name}
                  fill
        ...
        <div className="mt-16 text-center">
          <Link
            href="/shop"
            className="inline-block px-10 py-4 bg-[#d4af37] text-white text-sm font-bold uppercase tracking-widest rounded-full hover:bg-[#404040] transition-all shadow-lg hover:shadow-xl hover:-translate-y-1"
          >
