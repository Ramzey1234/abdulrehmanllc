...
const categories = [
  {
    ...
    theme: "from-neutral-200/20 to-neutral-100/20",
  },
  {
    title: "Self Rituals",
    ...
    <section className="py-20 bg-white">
      <div className="container-page">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-serif text-[#0a0a0a] mb-4">
            Shop by Mood
          </h2>
          <p className="text-[#404040] font-light">
            Explore our collections designed for a sophisticated lifestyle.
          </p>
        </div>
