...
const features = [
  {
    ...
    icon: Sparkles,
    color: "bg-neutral-100 text-yellow-600",
  },
  {
  ...
  },
  {
    ...
    description:
      "Exceptional craftsmanship and premium materials in every detail.",
    icon: Shield,
...
export function VibrantWelcome() {
  return (
    <section className="relative py-20 overflow-hidden bg-gradient-to-br from-[#fafafa] via-[#ffffff] to-[#f5f5f5]">
      {/* Decorative colored blobs */}
      <div className="absolute top-0 right-0 w-96 h-96 bg-neutral-200/30 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-neutral-200/30 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2" />
      ...
      <div className="container-page relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <motion.h2
            ...
            className="text-4xl md:text-5xl font-serif text-[#171717] mb-6 leading-tight"
          >
            Welcome to{" "}
            <span className="text-[#d4af37] italic">Abdul Rehman</span>.
            <br />
          ...
          >
            We believe your space should be a reflection of your essence.
            Explore our carefully curated collections designed to bring modern
