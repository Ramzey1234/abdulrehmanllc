...
const items = [
  {
    ...
    desc: "Notes of rare botanicals and quiet luxury.",
  },
  {
    id: "touch",
    title: "The Touch",
    subtitle: "Premium Textures",
    img: "/assets/images/vase.avif",
    color: "bg-[#ede9fe]",
    textColor: "text-[#404040]",
    desc: "Craftsmanship that resonates with modern elegance.",
  },
  {
    id: "light",
    title: "The Light",
    ...
    fallbackImg: "/assets/images/lavendar.jpg",
    color: "bg-[#e5e5e5]",
    textColor: "text-[#d4af37]",
    desc: "Glow that transforms your space into a masterpiece.",
  },
  {
    id: "life",
    title: "The Life",
    ...
    desc: "Curating your world with intentional sophistication.",
  },
];
    ...
    <section className="py-20 bg-white overflow-hidden">
      <div className="container-page">
        <div className="text-center mb-16">
          <p className="text-xs font-bold tracking-[0.2em] text-[#c5a059] uppercase mb-4">
            Discover
          </p>
          <h2 className="text-4xl md:text-5xl font-serif text-[#0a0a0a]">
            Curated Dimensions
          </h2>
        </div>
