...
export default function ProductPage({ params }: { params: { id: string } }) {
  ...
  if (!product) {
    return (
      <div className="container-page py-32 text-center text-[#171717]">
        Product not found.
      </div>
    );
  }
  ...
  return (
    <section className="pt-28 pb-32 bg-[linear-gradient(to_bottom,#fafafa,#e5e5e5,#e5e5e5)] relative">
      <div
        className="
      ...
      <div className="container-page relative z-10">
        <div className="grid lg:grid-cols-2 gap-20 items-start">
          <div className="relative w-full h-[500px] rounded-[32px] overflow-hidden shadow-[0_20px_40px_rgba(0,0,0,0.1)] border border-[#e5e5e5]">
            <Image src={p.img} alt={p.name} fill className="object-cover" />
          </div>

          <div>
            <h1 className="text-4xl font-semibold text-[#171717] leading-tight tracking-tight">
              {p.name}
            </h1>

            <p className="mt-4 text-lg text-[#404040] leading-relaxed max-w-xl">
              {p.blurb}
            </p>

            <p className="mt-6 text-3xl font-medium text-[#171717]">
              ${p.price}
            </p>
            ...
            <div className="h-[1px] w-full bg-[#e5e5e5] my-10"></div>

            <div className="text-[#404040] leading-relaxed space-y-4 max-w-xl">
              <p>
            ...
            {products
              ...
              .map((rec) => (
                ...
                >
                  ...
                  <div className="p-6">
                    <h3 className="text-lg text-[#171717]">{rec.name}</h3>
                    <p className="mt-1 text-[#404040] text-sm">${rec.price}</p>
                  </div>
                </a>
              ))}
          </div>
