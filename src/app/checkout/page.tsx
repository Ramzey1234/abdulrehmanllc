...
export default function CheckoutPage() {
  ...
  return (
    <div className="min-h-screen bg-no-repeat bg-bottom bg-[#f0fdf4]">
      <main className="container-page section">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <div className="card p-8 bg-white/80 backdrop-blur-sm">
              <h2 className="text-2xl font-light text-[#064e3b] mb-3">
                Payment Method
              </h2>
            ...
            <div className="card p-8 sticky top-20 bg-white/80 backdrop-blur-sm">
                ...
                <div className="space-y-4 mb-6">
                  {cart.map((item) => (
                    <div key={item.id} className="flex justify-between">
                      <span className="text-[#065f46] font-light">
              ...
              <div className="space-y-4 pb-8 border-b border-neutral-200">
                <div className="flex justify-between">
                  <span className="text-[#065f46] font-light">Subtotal</span>
                  <span className="text-[#064e3b] font-light">
                    ${subtotal.toFixed(2)}
                  </span>
                </div>
                ...
                <div className="flex justify-between">
                  <span className="text-[#065f46] font-light">Tax (8%)</span>
                  <span className="text-[#064e3b] font-light">
                    ${tax.toFixed(2)}
                  </span>
                </div>
                ...
                <div className="flex justify-between">
                  <span className="text-[#065f46] font-light">Shipping</span>
                  <span className="text-[#064e3b] font-light">
              ...
              <button
                onClick={placeOrder}
                className="w-full px-7 py-3 rounded-full bg-[#059669] text-[#ecfdf5] font-medium shadow-md shadow-[#059669]/30 hover:bg-[#047857] transition"
              >
                Place Order
              </button>
            </div>
      ...
      <Dialog open={showError} onOpenChange={setShowError}>
        <DialogContent className="bg-white/90 backdrop-blur-md rounded-2xl border border-[#d1fae5] shadow-xl p-8">
          <DialogHeader>
            <DialogTitle className="text-[#059669] font-medium">
              Missing Information
            </DialogTitle>
            <DialogDescription className="text-[#064e3b] text-sm leading-relaxed mt-2">
